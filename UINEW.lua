...
function Library:CreateWindow(Setting)
	...
	SearchBox.Text = ""
	SearchBox.TextColor3 = Color3.fromRGB(200, 225, 235)
	...
	function Main_Function:AddTab(PageName, IconId)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			Sectiontitle.Text = "<font color=\"rgb(0,180,220)\">▸</font> " .. Section_Name
			...
			local sectionFunction = {}
				...
				check.BackgroundColor3 = Color3.fromRGB(0, 210, 230) -- xanh da trời (base)
    ...
    ButtonClick()
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				if Desc and Desc ~= "" then
					...
					TextDesc.Text = Desc
					TextDesc.TextColor3 = Color3.fromRGB(100, 140, 155)
				...
				Button_1.Text = "Click"
				Button_1.TextColor3 = Color3.fromRGB(255, 210, 80)
            ...
            function sectionFunction:AddDropdownSection(Setting)
                ...
                DropdownButton.Text = ""
                DropdownButton.TextColor3 = Color3.fromRGB(255, 210, 80)
