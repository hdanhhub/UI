...
-- ============================================================
local T1UIColor = {
    ["Border Color"]                  = Color3.fromRGB(212, 175, 55),
    ["Click Effect Color"]            = Color3.fromRGB(255, 215, 0),
    ["Setting Icon Color"]            = Color3.fromRGB(220, 220, 230),
    ["Logo Image"]                    = "rbxassetid://123613996022560",
    ["Search Icon Color"]             = Color3.fromRGB(212, 175, 55),
    ...
    ["Background Main Color"]         = Color3.fromRGB(18, 20, 30),
    ["Background 1 Color"]            = Color3.fromRGB(28, 30, 42),
    ["Background 1 Transparency"]     = 0.05,
    ["Background 2 Color"]            = Color3.fromRGB(38, 40, 55),
    ["Background 3 Color"]            = Color3.fromRGB(32, 34, 46),
    ["Background Image"]              = "",

    ["Page Selected Color"]           = Color3.fromRGB(212, 175, 55),
    ["Section Text Color"]            = Color3.fromRGB(212, 175, 55),
    ["Section Underline Color"]       = Color3.fromRGB(212, 175, 55),
    ["Toggle Border Color"]           = Color3.fromRGB(100, 100, 120),
    ["Toggle Checked Color"]          = Color3.fromRGB(212, 175, 55),
...
mainButton.BackgroundColor3 = Color3.fromRGB(28, 30, 42)
...
uis.InputEnded:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		...
		if math.abs(delta.X) < CLICK_DISTANCE and math.abs(delta.Y) < CLICK_DISTANCE then
			...
			if isToggled then
				TweenService:Create(mainButton, tweenOn, { BackgroundColor3 = Color3.fromRGB(38, 40, 55) }):Play()
			else
				TweenService:Create(mainButton, tweenOff, { BackgroundColor3 = Color3.fromRGB(18, 20, 30) }):Play()
			end
		end
...
mainButton.MouseEnter:Connect(function()
	...
	TweenService:Create(mainButton, hoverTweenInfo, { BackgroundColor3 = Color3.fromRGB(32, 34, 46) }):Play()
end)
...
mainButton.MouseButton1Down:Connect(function()
	TweenService:Create(mainButton, hoverTweenInfo, { Size = UDim2.new(0, 58, 0, 58), BackgroundColor3 = Color3.fromRGB(18, 20, 30) }):Play()
end)
...
local libCreateNoti = function(Setting)
    ...
    TextLabelNoti.Text = "<font color=\"rgb(" .. tostring(color or "255,215,0") .. ")\">HDanh Hub</font> " .. tostring(getgenv().TitleNameNoti or "")
...
function Library:CreateWindow(Setting)
	...
	uistr.Thickness = 1;
	uistr.Color = Color3.fromRGB(212, 175, 55);
	...
	function Main_Function:AddTab(PageName, IconId)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			if SectionGap then
				...
				GapFrame.Name = "SectionGap"
				GapFrame.Parent = PageList
				GapFrame.Size = UDim2.new(1, -5, 0, 30)
				GapFrame.ClipsDescendants = true
				GapFrame.Transparency = 1
			end
			...
			function sectionFunction:AddToggle(idk, Setting)
				...
				check.BackgroundColor3 = Color3.fromRGB(212, 175, 55)
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				local Callback = Setting.Callback or Setting.Func or Callback or function() end
			...
			function sectionFunction:AddLabel(text)
				...
				LabelBG.Size = UDim2.new(1, -10, 0, 25)
				...
				TextColor.Text = text
				TextColor.TextColor3 = Color3.fromRGB(212, 175, 55)
				...
				return {
					SetText = function(t) TextColor.Text = t end,
					SetColor = function(c) TextColor.TextColor3 = c end
				}
			end
