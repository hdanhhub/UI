...
-- ============================================================
-- THEME: DARK ELEGANCE – Xanh đen huyền bí + Vàng gold sang trọng
-- Phối màu chủ đạo: nền tối xanh/xám, accent vàng kim loại, chữ trắng/vàng nhạt
-- ============================================================
local T1UIColor = {
    ["Border Color"]                  = Color3.fromRGB(212, 175, 55), -- vàng gold
    ["Click Effect Color"]            = Color3.fromRGB(255, 215, 0), -- vàng sáng
    ["Setting Icon Color"]            = Color3.fromRGB(220, 220, 230), -- xám sáng
    ["Logo Image"]                    = "rbxassetid://123613996022560",
    ["Search Icon Color"]             = Color3.fromRGB(212, 175, 55), -- vàng
    ["Search Icon Highlight Color"]   = Color3.fromRGB(255, 215, 0), -- vàng sáng
    ["GUI Text Color"]                = Color3.fromRGB(255, 255, 255), -- trắng tinh
    ["Text Color"]                    = Color3.fromRGB(240, 240, 245), -- trắng xám nhẹ
    ["Placeholder Text Color"]        = Color3.fromRGB(140, 140, 155), -- xám tím nhạt
    ["Title Text Color"]              = Color3.fromRGB(255, 215, 0), -- vàng gold

    ["Background Main Color"]         = Color3.fromRGB(18, 20, 30),  -- xanh đen rất tối
    ["Background 1 Color"]            = Color3.fromRGB(28, 30, 42),  -- lớp 1
    ["Background 1 Transparency"]     = 0.05,
    ["Background 2 Color"]            = Color3.fromRGB(38, 40, 55),  -- lớp 2
    ["Background 3 Color"]            = Color3.fromRGB(32, 34, 46),  -- lớp 3
    ["Background Image"]              = "",

    ["Page Selected Color"]           = Color3.fromRGB(212, 175, 55), -- vàng
    ["Section Text Color"]            = Color3.fromRGB(212, 175, 55), -- vàng
    ["Section Underline Color"]       = Color3.fromRGB(212, 175, 55),
    ["Toggle Border Color"]           = Color3.fromRGB(100, 100, 120), -- xám thép
    ["Toggle Checked Color"]          = Color3.fromRGB(212, 175, 55), -- vàng
    ["Toggle Desc Color"]             = Color3.fromRGB(190, 190, 200),

    ["Button Color"]                  = Color3.fromRGB(38, 40, 55),
    ["Label Color"]                   = Color3.fromRGB(28, 30, 42),
    ["Dropdown Icon Color"]           = Color3.fromRGB(212, 175, 55),
    ["Dropdown Selected Color"]       = Color3.fromRGB(212, 175, 55),
    ["Dropdown Selected Check Color"] = Color3.fromRGB(255, 215, 0),

    ["Textbox Highlight Color"]       = Color3.fromRGB(212, 175, 55),
    ["Box Highlight Color"]           = Color3.fromRGB(212, 175, 55),
    ["Slider Line Color"]             = Color3.fromRGB(50, 52, 68),
...
mainButton.BackgroundColor3 = Color3.fromRGB(28, 30, 42) -- Background 1
...
UIStroke.Color = Color3.fromRGB(212, 175, 55)  -- Vàng
		...
		if math.abs(delta.X) < CLICK_DISTANCE and math.abs(delta.Y) < CLICK_DISTANCE then
			...
			if isToggled then
				TweenService:Create(mainButton, tweenOn, {
					BackgroundColor3 = Color3.fromRGB(38, 40, 55) -- Background 2
				}):Play()
			else
				TweenService:Create(mainButton, tweenOff, {
					BackgroundColor3 = Color3.fromRGB(18, 20, 30) -- Background Main
				}):Play()
			end

			print("UI TOGGLED:", isToggled)
		end
...
mainButton.MouseEnter:Connect(function()
    ...
    TweenService:Create(mainButton, hoverTweenInfo, {
        BackgroundColor3 = Color3.fromRGB(32, 34, 46) -- Background 3
    }):Play()
end)

mainButton.MouseLeave:Connect(function()
    isHovering = false
    local targetColor = isToggled and Color3.fromRGB(18, 20, 30) or Color3.fromRGB(38, 40, 55)
...
NotiContainer.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
...
local libCreateNoti = function(Setting)
	...
	NotiFrame.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
	...
	Topnoti.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
	...
	Ruafimg.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
    ...
    TextLabelNoti.Text = "<font color=\"rgb(" .. tostring(color or "255,215,0") .. ")\">" .. tostring(TitleNameMain or "HDanh Hub") .. "</font> " .. tostring(getgenv().TitleNameNoti or "")
    
	TextLabelNoti.Name = "TextLabelNoti"
	TextLabelNoti.Parent = Topnoti
	TextLabelNoti.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
	...
	CloseContainer.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
	...
	CloseImage.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
	...
	TextButton.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
	...
	if Description then
		...
		TextLabelNoti2.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
...
function Library:CreateWindow(Setting)
	...
	Main.BackgroundColor3 = Color3.fromRGB(28, 30, 42)
	...
	maingui.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
	...
	MainContainer.BackgroundColor3 = Color3.fromRGB(18, 20, 30)
	MainContainer.Size = UDim2.new(1, 0, 1, 0)

	local uistr = Instance.new("UIStroke", MainContainer);
	uistr.Thickness = 1;
	uistr.Color = Color3.fromRGB(212, 175, 55); -- Vàng
	...
	Concacontainer.BackgroundColor3 = Color3.fromRGB(28, 30, 42)
	...
	Concacmain.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
	...
	TopMain.BackgroundColor3 = Color3.fromRGB(32, 34, 46)
	...
	TopStroke.BackgroundColor3 = Color3.fromRGB(212, 175, 55)
	...
	TextLabelMain.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
   ...
   TextLabelMain.Text = "<font color=\"rgb(255,215,0)\">" .. tostring(TitleNameMain or "HDanh Hub") .. "</font> <font color=\"rgb(240,240,245)\">" .. tostring(getgenv().MainDesc or "") .. "</font>"
	...
	PageControl.BackgroundColor3 = Color3.fromRGB(22, 24, 35)
	PageControl.BackgroundTransparency = 0.1

	local pageControlStroke = Instance.new("UIStroke", PageControl)
	pageControlStroke.Color = Color3.fromRGB(212, 175, 55)
	...
	pageControlGradient.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(22, 24, 35)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(32, 34, 46))
	}
	...
	ControlList.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
	...
	ControlTitle.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
	...
	PageSearch.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
	...
	SearchIcon.ImageColor3 = Color3.fromRGB(212, 175, 55)
	...
	MainPage.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
	...
	local PageCounter = 1
		...
		PageNameControl.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
		...
		Frame.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
		...
		TabTitleContainer.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
		...
		TabTitle.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
		...
		PageButton.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
		PageButton.BackgroundTransparency = 1.000
		PageButton.Size = UDim2.new(1, 0, 1, 0)
		PageButton.Font = Enum.Font.SourceSans
		PageButton.Text = ""
		PageButton.TextColor3 = Color3.fromRGB(240, 240, 245)
		...
		PageTitle.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
		...
		PageList.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			sectionStroke.Color = Color3.fromRGB(212, 175, 55)
			sectionStroke.Thickness = 1

			local sectionGradient = Instance.new("UIGradient", Section)
			sectionGradient.Color = ColorSequence.new{
				ColorSequenceKeypoint.new(0, Color3.fromRGB(38, 40, 55)),
			...
			Topsec.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
			Topsec.BackgroundTransparency = 1.000
			Topsec.Size = UDim2.new(0, 415, 0, 30)

			Sectiontitle.Name = "Sectiontitle"
			Sectiontitle.Parent = Topsec
			Sectiontitle.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
			...
			if Toggleable then
				...
				VisibilityButton.BorderColor3 = Color3.fromRGB(100, 100, 120)
				VisibilityButton.BorderSizePixel = 0
				VisibilityButton.Font = Enum.Font.SourceSans
				VisibilityButton.Text = ""
				VisibilityButton.TextColor3 = Color3.fromRGB(240, 240, 245)
				...
				VisibilitySectionFrame.BackgroundColor3 = Color3.fromRGB(28, 30, 42)
				VisibilitySectionFrame.BorderColor3 = Color3.fromRGB(100, 100, 120)
			...
			local sectionFunction = {}
				...
				ToggleFrame.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
				...
				TogFrame1.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
				...
				checkbox.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
				...
				check.BackgroundColor3 = Color3.fromRGB(212, 175, 55) -- vàng gold (base)
				check.Position = UDim2.new(0.5, 0, 0.5, 0)
				-- Gradient vàng nhạt → vàng đậm khi bật
				local checkGradient = Instance.new("UIGradient")
				checkGradient.Color = ColorSequence.new({
					ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 235, 160)),
				...
				if Desc and Desc ~= "" then
					...
					ToggleDesc.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
				...
				ToggleTitle.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
				...
				ToggleButton.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
    ...
    ButtonClick()
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				if Desc and Desc ~= "" then
					...
					TextDesc.Text = Desc
					TextDesc.TextColor3 = Color3.fromRGB(190, 190, 200)
				...
				UIGradient_1.Color = ColorSequence.new{
					...
					ColorSequenceKeypoint.new(0.4, Color3.fromRGB(255, 235, 160)),
					ColorSequenceKeypoint.new(0.6, Color3.fromRGB(255, 235, 160)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(212, 175, 55))
				}
			...
			function sectionFunction:AddLabel(text)
                ...
                TextColor.TextColor3 = Color3.fromRGB(212, 175, 55) -- vàng
            ...
            function sectionFunction:AddDropdownSection(Setting)
                ...
                DropdownFrame.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
                ...
                Dropdowntitle.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
                ...
                DropdownButton.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
                ...
                Dropdownlisttt.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
                
                DropdownScroll.Name = "DropdownScroll"
                DropdownScroll.Parent = Dropdownlisttt
                DropdownScroll.Active = true
                DropdownScroll.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
                ...
                ScrollContainer.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
                ...
                InternalSection.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
               ...
               local dropdownSectionFunction = {}
                ...
                function dropdownSectionFunction:AddSlider(Setting)
                    ...
                    SliderFrame.BackgroundColor3 = Color3.fromRGB(50, 52, 68)
                    ...
                    SliderBG.BackgroundColor3 = Color3.fromRGB(28, 30, 42)
                    ...
                    SliderTitle.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
                    ...
                    SliderButton.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
                    ...
                    Sliderbox_2.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
				...
				local function refreshlist(SortPairs)
					...
					if Selected then
                        for _, i in ipairs(OrderedList) do
							...
							SampleItem.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
							...
							SampleItemTitle.TextColor3 = Color3.fromRGB(240, 240, 245)
							...
							SampleItemButton.BorderColor3 = Color3.fromRGB(100, 100, 120)
...
function sectionFunction:AddKeyBind(Setting, Callback)
    ...
    BindButtonTitle.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
    ...
    Bindkey.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
    ...
    return keybindFunction
			...
			function sectionFunction:AddInput(idk, Setting)
				...
				Boxtitle.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
				...
				Boxxx.Parent = BoxCor
				Boxxx.BackgroundColor3 = Color3.fromRGB(38, 40, 55)
