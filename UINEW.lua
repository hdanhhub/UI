...
function Library:CreateWindow(Setting)
	...
	function Main_Function:AddTab(PageName, IconId)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			-- Left accent bar section (ZIndex overlay - không ảnh hưởng UIListLayout)
			local sectionAccent = Instance.new("Frame")
			sectionAccent.Size = UDim2.new(0, 2, 0, 28)
			sectionAccent.Position = UDim2.new(0, 0, 0, 0)
			...
			-- FIX: Đẩy content xuống dưới header Topsec (28px)
			local SectionListPadding = Instance.new("UIPadding")
			SectionListPadding.PaddingTop = UDim.new(0, 28)
			SectionListPadding.Parent = Section
			...
			SectionList:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
				SizeSectionY = SectionList.AbsoluteContentSize.Y + 28 + 5
