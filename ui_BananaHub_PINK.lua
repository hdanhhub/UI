...
local T1UIColor = {
    ...
    ["Click Effect Color"] = Color3.fromRGB(220, 80, 140),
    ["Setting Icon Color"] = Color3.fromRGB(200, 200, 200),
    ["Logo Image"] = "rbxassetid:// 89947810111304",
    ["Search Icon Color"] = Color3.fromRGB(220, 80, 140),
    ["Search Icon Highlight Color"] = Color3.fromRGB(255, 100, 170),
    ...
    ["Page Selected Color"] = Color3.fromRGB(220, 80, 140),
    ["Section Text Color"] = Color3.fromRGB(255, 255, 255),
    ["Section Underline Color"] = Color3.fromRGB(220, 80, 140),
    ["Toggle Border Color"] = Color3.fromRGB(70, 70, 70),
    ["Toggle Checked Color"] = Color3.fromRGB(220, 80, 140),
    ["Toggle Desc Color"] = Color3.fromRGB(180, 180, 180),
    
    ["Button Color"] = Color3.fromRGB(35, 35, 35),
    ["Label Color"] = Color3.fromRGB(28, 28, 28),
    ["Dropdown Icon Color"] = Color3.fromRGB(220, 80, 140),
    ["Dropdown Selected Color"] = Color3.fromRGB(220, 80, 140),
    ["Dropdown Selected Check Color"] = Color3.fromRGB(255, 255, 255),
    
    ["Textbox Highlight Color"] = Color3.fromRGB(220, 80, 140),
    ["Box Highlight Color"] = Color3.fromRGB(220, 80, 140),
    ["Slider Line Color"] = Color3.fromRGB(45, 45, 45),
    ["Slider Highlight Color"] = Color3.fromRGB(220, 80, 140),
...
-- Bo tròn icon để ảnh hiển thị hình tròn thay vì vuông
	...
	local PageCounter = 1
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			local sectionFunction = {}
				...
				check.BackgroundColor3 = Color3.fromRGB(200, 60, 120)
