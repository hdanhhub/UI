...
-- ICON - dung Scale de khop vua vong tron
...
icon.Image = "rbxassetid://89947810111304"
...
-- Fade tween cho icon
local faded = false
local fadeOutTween = TweenService:Create(icon, defaultTweenInfo, { ImageTransparency = 0.6 })
...
mainButton.MouseButton1Click:Connect(function()
    ...
    local iconScaleTween = TweenService:Create(icon, clickTweenInfo, {
        Size = isToggled and UDim2.new(0.60, 0, 0.60, 0) or UDim2.new(0.65, 0, 0.65, 0)
    })
