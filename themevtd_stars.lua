...
local redzlib = {
    ...
    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(10, 5, 30)),
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(60, 20, 120)),
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(10, 5, 30))
}),
["Color Hub 2"] = Color3.fromRGB(8, 4, 20),
["Color Stroke"] = Color3.fromRGB(100, 60, 200),
["Color Theme"] = Color3.fromRGB(140, 80, 255),
["Color Text"] = Color3.fromRGB(220, 210, 255),
["Color Dark Text"] = Color3.fromRGB(140, 120, 200)
        }
    },
	Info = {
		Version = "1.1.0"
	...
	local function SpawnStar()
		local star = Create("Frame", StarContainer, {
			...
			BackgroundColor3 = (function()
				...
				if r == 1 then return Color3.fromRGB(255, 255, 255)
				elseif r == 2 then return Color3.fromRGB(180, 160, 255)
				else return Color3.fromRGB(140, 200, 255) end
			end)(),
			BorderSizePixel = 0,
			ZIndex = 1,
		})
