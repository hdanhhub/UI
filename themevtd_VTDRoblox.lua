...
local redzlib = {
    ...
    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(18, 12, 8)),
    ColorSequenceKeypoint.new(0.30, Color3.fromRGB(45, 30, 15)),
    ColorSequenceKeypoint.new(0.55, Color3.fromRGB(30, 20, 50)),
    ColorSequenceKeypoint.new(0.80, Color3.fromRGB(50, 35, 12)),
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(18, 12, 8))
}),
["Color Hub 2"] = Color3.fromRGB(22, 16, 10),
["Color Stroke"] = Color3.fromRGB(160, 120, 60),
["Color Theme"] = Color3.fromRGB(200, 160, 80),
["Color Text"] = Color3.fromRGB(240, 230, 210),
["Color Dark Text"] = Color3.fromRGB(180, 155, 110)
        }
    },
	Info = {
		Version = "1.1.0"
...
function redzlib:MakeWindow(Configs)
	...
	-- ✨ STAR FIELD EFFECT - Đóm đóm ngôi sao vũ trụ ✨
	local StarContainer = Create("Frame", MainFrame, {
		Size = UDim2.fromScale(1, 1),
		BackgroundTransparency = 1,
		ZIndex = 0,
	...
	local function SpawnStar()
		local star = Create("Frame", StarContainer, {
			Size = UDim2.fromOffset(math.random(1, 3), math.random(1, 3)),
			Position = UDim2.fromScale(math.random(0, 100) / 100, math.random(0, 100) / 100),
			BackgroundColor3 = (function()
				local r = math.random(1, 5)
				if r == 1 then return Color3.fromRGB(255, 255, 240)      -- trắng vàng
				elseif r == 2 then return Color3.fromRGB(255, 210, 130)  -- vàng cam
				elseif r == 3 then return Color3.fromRGB(255, 120, 60)   -- cam đỏ nebula
				elseif r == 4 then return Color3.fromRGB(180, 150, 255)  -- tím xanh
				else return Color3.fromRGB(140, 200, 255) end            -- xanh nhạt
			end)(),
			BorderSizePixel = 0,
			ZIndex = 1,
		})
		local corner = Create("UICorner", star, { CornerRadius = UDim.new(1, 0) })

		local baseTransparency = math.random(20, 70) / 100

		task.spawn(function()
			while star and star.Parent do
				-- Twinkle in
				local tweenIn = TweenService:Create(star, TweenInfo.new(math.random(8, 20) / 10, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
				...
				-- Twinkle out
				local tweenOut = TweenService:Create(star, TweenInfo.new(math.random(8, 20) / 10, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut), {
					BackgroundTransparency = math.min(baseTransparency + 0.4, 0.97)
				})
				tweenOut:Play()
