...
-- ============================================================
-- THEME: XANH NƯỚC CHỦ ĐẠO (FULL CYAN TEAL)
-- Nền teal tối sâu + accent cyan sáng + chữ vàng/trắng sáng
-- ============================================================
local T1UIColor = {
    ["Border Color"]                  = Color3.fromRGB(120,225,235), -- cyan nhạt
    ["Click Effect Color"]            = Color3.fromRGB(0,200,220), -- xanh da trời
    ["Setting Icon Color"]            = Color3.fromRGB(200,240,248), -- cyan trắng nhạt
    ["Logo Image"]                    = "rbxassetid://123613996022560",
    ["Search Icon Color"]             = Color3.fromRGB(0,200,220), -- xanh da trời
    ["Search Icon Highlight Color"]   = Color3.fromRGB(80,215,230), -- xanh nhạt hơn
    ["GUI Text Color"]                = Color3.fromRGB(255, 240, 180), -- vàng kem sáng
    ["Text Color"]                    = Color3.fromRGB(255, 240, 180), -- vàng kem sáng
    ["Placeholder Text Color"]        = Color3.fromRGB(100,175,195), -- cyan xám
    ["Title Text Color"]              = Color3.fromRGB(200,245,252), -- cyan trắng sáng

    ["Background Main Color"]         = Color3.fromRGB(20,48,60),  -- teal navy tối
    ["Background 1 Color"]            = Color3.fromRGB(28,62,78),  -- teal lớp 1
    ["Background 1 Transparency"]     = 0.05,
    ["Background 2 Color"]            = Color3.fromRGB(32,70,88),  -- teal lớp 2
    ["Background 3 Color"]            = Color3.fromRGB(25,58,72),  -- teal lớp 3
    ["Background Image"]              = "",

    ["Page Selected Color"]           = Color3.fromRGB(0,200,220), -- xanh da trời
    ["Section Text Color"]            = Color3.fromRGB(180,240,248), -- cyan nhạt sáng
    ["Section Underline Color"]       = Color3.fromRGB(0,200,220), -- xanh da trời
    ["Toggle Border Color"]           = Color3.fromRGB(50,155,180), -- teal vừa
    ["Toggle Checked Color"]          = Color3.fromRGB(0,200,220), -- xanh da trời
    ["Toggle Desc Color"]             = Color3.fromRGB(200,240,248), -- cyan trắng nhạt

    ["Button Color"]                  = Color3.fromRGB(32,70,88),  -- teal nhạt
    ["Label Color"]                   = Color3.fromRGB(25,58,72),  -- teal tối
    ["Dropdown Icon Color"]           = Color3.fromRGB(0,200,220), -- xanh da trời
    ["Dropdown Selected Color"]       = Color3.fromRGB(0,200,220), -- xanh da trời
    ["Dropdown Selected Check Color"] = Color3.fromRGB(255, 240, 180), -- vàng kem

    ["Textbox Highlight Color"]       = Color3.fromRGB(0,200,220), -- xanh da trời
    ["Box Highlight Color"]           = Color3.fromRGB(120,225,235), -- cyan nhạt
    ["Slider Line Color"]             = Color3.fromRGB(35,85,105),  -- teal tối
    ["Slider Highlight Color"]        = Color3.fromRGB(0,200,220), -- xanh da trời
...
mainButton.BackgroundColor3 = Color3.fromRGB(28,62,78)
...
UIStroke.Color = Color3.fromRGB(0,200,220)
		...
		if math.abs(delta.X) < CLICK_DISTANCE and math.abs(delta.Y) < CLICK_DISTANCE then
			...
			if isToggled then
				TweenService:Create(mainButton, tweenOn, {
					BackgroundColor3 = Color3.fromRGB(32,70,88)
				}):Play()
			else
				TweenService:Create(mainButton, tweenOff, {
					BackgroundColor3 = Color3.fromRGB(20,48,60)
				}):Play()
			end
...
mainButton.MouseEnter:Connect(function()
    ...
    TweenService:Create(mainButton, hoverTweenInfo, {
        BackgroundColor3 = Color3.fromRGB(25,58,72)
    }):Play()
end)

mainButton.MouseLeave:Connect(function()
    isHovering = false
    local targetColor = isToggled and Color3.fromRGB(20,48,60) or Color3.fromRGB(32,70,88)
...
NotiContainer.BackgroundColor3 = Color3.fromRGB(32,70,88)
...
local libCreateNoti = function(Setting)
	...
	NotiFrame.BackgroundColor3 = Color3.fromRGB(32,70,88)
	...
	Topnoti.BackgroundColor3 = Color3.fromRGB(32,70,88)
	...
	Ruafimg.BackgroundColor3 = Color3.fromRGB(32,70,88)
	...
	TextLabelNoti.BackgroundColor3 = Color3.fromRGB(32,70,88)
	...
	CloseContainer.BackgroundColor3 = Color3.fromRGB(32,70,88)
	...
	CloseImage.BackgroundColor3 = Color3.fromRGB(32,70,88)
	...
	TextButton.BackgroundColor3 = Color3.fromRGB(32,70,88)
	...
	if Description then
		...
		TextLabelNoti2.BackgroundColor3 = Color3.fromRGB(32,70,88)
...
function Library:CreateWindow(Setting)
	...
	Main.BackgroundColor3 = Color3.fromRGB(28,62,78)
	...
	maingui.BackgroundColor3 = Color3.fromRGB(32,70,88)
	...
	MainContainer.BackgroundColor3 = Color3.fromRGB(20,48,60)
	MainContainer.Size = UDim2.new(1, 0, 1, 0)

	local uistr = Instance.new("UIStroke", MainContainer);
	uistr.Thickness = 1;
	uistr.Color = Color3.fromRGB(120,225,235);

	local uigradient = Instance.new("UIGradient", MainContainer);
	uigradient.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(150,235,245)),
	...
	Concacontainer.BackgroundColor3 = Color3.fromRGB(28,62,78)
	...
	Concacmain.BackgroundColor3 = Color3.fromRGB(32,70,88)
	...
	TopMain.BackgroundColor3 = Color3.fromRGB(25,58,72)
	...
	TopStroke.BackgroundColor3 = Color3.fromRGB(0,200,220)
	...
	TextLabelMain.BackgroundColor3 = Color3.fromRGB(32,70,88)
   ...
   TextLabelMain.Text = "<font color=\"rgb(100,225,240)\">" .. tostring(TitleNameMain or "Night Mystic") .. "</font> <font color=\"rgb(255,245,200)\">" .. tostring(getgenv().MainDesc or "") .. "</font>"
	...
	PageControl.BackgroundColor3 = Color3.fromRGB(15,42,55)
	PageControl.BackgroundTransparency = 0.1

	local pageControlStroke = Instance.new("UIStroke", PageControl)
	pageControlStroke.Color = Color3.fromRGB(80,190,210)
	...
	pageControlGradient.Color = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(15,42,55)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(22,52,66))
	}
	...
	ControlList.BackgroundColor3 = Color3.fromRGB(32,70,88)
	...
	ControlTitle.BackgroundColor3 = Color3.fromRGB(32,70,88)
	...
	PageSearch.BackgroundColor3 = Color3.fromRGB(22,52,66)
	...
	SearchIcon.ImageColor3 = Color3.fromRGB(100,220,235)
    ...
    SearchBox.PlaceholderColor3 = Color3.fromRGB(100,185,205)
    SearchBox.PlaceholderText = "Search section or Function..."
    SearchBox.Text = ""
    SearchBox.TextColor3 = Color3.fromRGB(255, 240, 180)
    SearchBox.TextSize = 14
    SearchBox.TextXAlignment = Enum.TextXAlignment.Left

	MainPage.Name = "MainPage"
	MainPage.Parent = Concacmain
	MainPage.BackgroundColor3 = Color3.fromRGB(32,70,88)
	...
	local PageCounter = 1
		...
		PageNameControl.BackgroundColor3 = Color3.fromRGB(32,70,88)
		...
		Frame.BackgroundColor3 = Color3.fromRGB(32,70,88)
		...
		Line.BackgroundColor3 = Color3.fromRGB(32,70,88)
		...
		TabTitleContainer.BackgroundColor3 = Color3.fromRGB(32,70,88)
		...
		TabTitle.BackgroundColor3 = Color3.fromRGB(32,70,88)
		...
		PageButton.BackgroundColor3 = Color3.fromRGB(32,70,88)
		PageButton.BackgroundTransparency = 1.000
		PageButton.Size = UDim2.new(1, 0, 1, 0)
		PageButton.Font = Enum.Font.SourceSans
		PageButton.Text = ""
		PageButton.TextColor3 = Color3.fromRGB(255, 240, 180)
		...
		PageTitle.BackgroundColor3 = Color3.fromRGB(32,70,88)
		...
		PageList.BackgroundColor3 = Color3.fromRGB(32,70,88)
		...
		SearchButton.Text = ""
		SearchButton.TextColor3 = Color3.fromRGB(255, 240, 180)
		...
		function pageFunction:AddSection(Section_Name, Toggleable, SectionGap, SectionColor)
			...
			sectionStroke.Color = Color3.fromRGB(80,190,210)
			sectionStroke.Thickness = 1

			local sectionGradient = Instance.new("UIGradient", Section)
			sectionGradient.Color = ColorSequence.new{
				ColorSequenceKeypoint.new(0, Color3.fromRGB(22,52,66)),
			...
			Topsec.BackgroundColor3 = Color3.fromRGB(32,70,88)
			Topsec.BackgroundTransparency = 1.000
			Topsec.Size = UDim2.new(0, 415, 0, 30)

			Sectiontitle.Name = "Sectiontitle"
			Sectiontitle.Parent = Topsec
			Sectiontitle.BackgroundColor3 = Color3.fromRGB(32,70,88)
			...
			if Toggleable then
				...
				VisibilityButton.BorderColor3 = Color3.fromRGB(50,155,180)
				VisibilityButton.BorderSizePixel = 0
				VisibilityButton.Font = Enum.Font.SourceSans
				VisibilityButton.Text = ""
				VisibilityButton.TextColor3 = Color3.fromRGB(255, 240, 180)
				...
				VisibilitySectionFrame.BackgroundColor3 = Color3.fromRGB(28,62,78)
				VisibilitySectionFrame.BorderColor3 = Color3.fromRGB(50,155,180)
			...
			local sectionFunction = {}
				...
				ToggleFrame.BackgroundColor3 = Color3.fromRGB(32,70,88)
				...
				TogFrame1.BackgroundColor3 = Color3.fromRGB(32,70,88)
				...
				checkbox.BackgroundColor3 = Color3.fromRGB(32,70,88)
				...
				check.BackgroundColor3 = Color3.fromRGB(0,200,220) -- xanh da trời (base)
				...
				checkGradient.Color = ColorSequence.new({
					ColorSequenceKeypoint.new(0, Color3.fromRGB(120,225,235)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(0,200,220)),
				})
				...
				if Desc and Desc ~= "" then
					...
					ToggleDesc.BackgroundColor3 = Color3.fromRGB(32,70,88)
				...
				ToggleTitle.BackgroundColor3 = Color3.fromRGB(32,70,88)
				...
				ToggleButton.BackgroundColor3 = Color3.fromRGB(32,70,88)
				ToggleButton.BackgroundTransparency = 1.000
				ToggleButton.Size = UDim2.new(1, 0, 1, 0)
				ToggleButton.Position = UDim2.new(0, 0, 0, 0)
				ToggleButton.Font = Enum.Font.SourceSans
				ToggleButton.Text = ""
				ToggleButton.TextColor3 = Color3.fromRGB(255, 240, 180)
    ...
    ButtonClick()
			...
			function sectionFunction:AddButton(Setting, Callback)
				...
				if Desc and Desc ~= "" then
					...
					TextDesc.Text = Desc
					TextDesc.TextColor3 = Color3.fromRGB(220, 190, 255)
				...
				UIGradient_1.Color = ColorSequence.new{
					...
					ColorSequenceKeypoint.new(0.4, Color3.fromRGB(80,215,230)),
					ColorSequenceKeypoint.new(0.6, Color3.fromRGB(120,225,235)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(0,200,220))
				}
				...
				Button_1.Text = "Click"
				Button_1.TextColor3 = Color3.fromRGB(255, 240, 180)
			...
			function sectionFunction:AddLabel(text)
                ...
                TextColor.TextColor3 = Color3.fromRGB(180,240,248)
            ...
            function sectionFunction:AddDropdownSection(Setting)
                ...
                DropdownFrame.BackgroundColor3 = Color3.fromRGB(32,70,88)
                ...
                Dropdowntitle.BackgroundColor3 = Color3.fromRGB(32,70,88)
                ...
                DropdownButton.BackgroundColor3 = Color3.fromRGB(32,70,88)
                ...
                DropdownButton.Text = ""
                DropdownButton.TextColor3 = Color3.fromRGB(255, 235, 170)
                ...
                Dropdownlisttt.BackgroundColor3 = Color3.fromRGB(32,70,88)
                
                DropdownScroll.Name = "DropdownScroll"
                DropdownScroll.Parent = Dropdownlisttt
                DropdownScroll.Active = true
                DropdownScroll.BackgroundColor3 = Color3.fromRGB(32,70,88)
                ...
                ScrollContainer.BackgroundColor3 = Color3.fromRGB(32,70,88)
                ...
                InternalSection.BackgroundColor3 = Color3.fromRGB(32,70,88)
               ...
               local dropdownSectionFunction = {}
                ...
                function dropdownSectionFunction:AddSlider(Setting)
                    ...
                    SliderFrame.BackgroundColor3 = Color3.fromRGB(35,85,105)
                    ...
                    SliderBG.BackgroundColor3 = Color3.fromRGB(15,42,55)
                    ...
                    SliderTitle.BackgroundColor3 = Color3.fromRGB(32,70,88)
                    ...
                    SliderButton.BackgroundColor3 = Color3.fromRGB(32,70,88)
                    SliderButton.BackgroundTransparency = 1.000
                    SliderButton.Size = UDim2.new(1, 0, 1, 0)
                    SliderButton.Font = Enum.Font.GothamBold
                    SliderButton.Text = ""
                    SliderButton.TextColor3 = Color3.fromRGB(230, 200, 255)
                    ...
                    Sliderbox_2.BackgroundColor3 = Color3.fromRGB(32,70,88)
				...
				local function refreshlist(SortPairs)
					...
					if Selected then
                        for _, i in ipairs(OrderedList) do
							...
							SampleItem.BackgroundColor3 = Color3.fromRGB(32,70,88)
							...
							SampleItemTitle.TextColor3 = Color3.fromRGB(255, 240, 180)
							...
							SampleItemButton.BorderColor3 = Color3.fromRGB(50,155,180)
...
function sectionFunction:AddKeyBind(Setting, Callback)
    ...
    BindButtonTitle.BackgroundColor3 = Color3.fromRGB(32,70,88)
    ...
    Bindkey.BackgroundColor3 = Color3.fromRGB(32,70,88)
    ...
    return keybindFunction
			...
			function sectionFunction:AddInput(idk, Setting)
				...
				Boxtitle.BackgroundColor3 = Color3.fromRGB(32,70,88)
				...
				Boxxx.Parent = BoxCor
				Boxxx.BackgroundColor3 = Color3.fromRGB(32,70,88)
